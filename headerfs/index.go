...
const (
	// Block is the header type that represents regular Flokicoinin block
	// headers.
...
const (
	...
	// serialized hash since all Flokicoin hashes are reverse-serialized when
