...
// fully fledged database for Flokicoin block headers. The blockHeaderStore
...
// BlockHeader is a Flokicoin block header that also has its height included.
...
// standard Flokicoin algorithm to compute block locators are employed.
func (h *blockHeaderStore) BlockLocatorFromHash(hash *chainhash.Hash) (
	blockchain.BlockLocator, error) {
